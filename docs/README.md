...
- C# 6.0, 7.0, 8.0, 9.0, 10.0, 11.0（4 年）
...
- プロジェクト詳細 :
  ...
  - 言語/フレームワーク : C#10.0 + .NET6, C#11.0 + .NET7 での
  - インフラ : Azure, AWS
  - GitHub Actions での CI/CD 環境構築
...
- 3D アクションゲームが好きで個人開発したいと考えています
  - 現在はどのように作るのか本や公開されているコードなどを読んで勉強しております
- 低レイヤに対する興味が湧いたので、最近マスタリング TCP/IP を読み始めました
  - 現在ネットワークスペシャリストの資格を取るために勉強しています
